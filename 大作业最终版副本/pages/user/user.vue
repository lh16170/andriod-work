	...
	<view class="">
		<view class="center">
			...
			<view class="center-list">
				<view class="center-list-item border-bottom" @click="topage1()">
			...
			<view class="center-list">
				<view class="center-list-item" @click="topage4()">
					<text class="list-icon">&#xe65f;</text>
			...
			<view class="center-list">
				<view class="center-list-item" @click="topage5()">
					<text class="list-icon">&#xe614;</text>
...
<script>
	...
	export default {
		...
		methods: {
			...
			topage1() {
				uni.navigateTo({
					url: '/pages/user/page1/page1'
				})
			},
			topage2() {
				uni.navigateTo({
					url: '/pages/user/page2/page2'
				})
			},
			topage3() {
				uni.navigateTo({
					url: '/pages/user/page3/page3'
				})
			},
			topage4() {
				uni.navigateTo({
					url: '/pages/user/page4/page4'
				})
			},
			topage5() {
				uni.navigateTo({
