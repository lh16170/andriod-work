<template>
	<view class="container">
		<view class="banner">
			<image src="/static/images/index/主页.jpg" mode="" class="bg"></image>
			<view class="intro">
				<view class="greet">您好，{{ isLogin ? member.nickname : '山师er' }}</view>
				<view class="note">弘德明志 博学笃行</view>
			</view>
		</view>
		<view class="content">
			<view class="entrance">
			...
			<view class="navigators">
				<view class="left">
					<view class="grid flex-column just-content-center"@tap="yaowen">
						<view class="d-flex align-items-center">
							<image src="/static/images/index/csc.png" class="mark-img"></image>
							<view class="font-size-sm text-color-base">师大要闻</view>
						</view>
						<view class="text-color-assist" style="margin-left: 40rpx; font-size: 20rpx;">NEWS OF SDNU</view>
					</view>
					<view class="grid justify-content-end align-items-end" @tap="yaowen">
			...
			<view class="member-news">
				<view class="header" >
					<view class="title">师大爆料</view>
					<view class="iconfont iconRightbutton" @tap="interest"></view>
				</view>
				<view class="list">
					<view class="item">
						<image src="/static/images/index/333.jpg"></image>
						<view class="title">我喜欢夏天的雨，雨后的光和“杉诗”的你</view>
					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			invite() {
				uni.navigateTo({
					url: '/pages/xueshu/index'
				})
			},
			yaowen() {
				uni.navigateTo({
					url: '/pages/yaowen/index'
				})
			},
			interest() {
				uni.navigateTo({
